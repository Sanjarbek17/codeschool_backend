...
class HomeworkSubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'code_text', 'file_upload', 'submitted_at', 
            'passed_tests', 'total_tests', 'success_rate', 'is_successful',
            'execution_time', 'memory_usage', 'file_size'
        ]
        read_only_fields = ['submitted_at', 'passed_tests', 'total_tests', 'execution_time', 'memory_usage']
...
class HomeworkSubmissionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HomeworkSubmission
        fields = [
            'id', 'student_name', 'task_title', 'submitted_at',
            'passed_tests', 'total_tests', 'success_rate', 'is_successful'
        ]
...
class HomeworkSubmissionCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HomeworkSubmission
        fields = ['task', 'code_text', 'file_upload']
...
class TestCaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TestCase
        fields = [
            'id', 'task', 'task_title', 'homework_title',
            'test_code', 'hidden', 'input_data', 'expected_output',
...
class TestCaseCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TestCase
        fields = ['task', 'test_code', 'hidden', 'input_data', 'expected_output', 'timeout_seconds']
...
class TestCaseStudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TestCase
        fields = ['id', 'task_title', 'input_data', 'expected_output', 'timeout_seconds']
