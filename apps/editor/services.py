...
def _execute_code_worker(
    code: str, test_input: str, timeout_seconds: int, memory_limit_mb: int, result_dict
):
    """
    Worker function for multiprocessing code execution.
    This function runs in a separate process to isolate code execution.
    """
    try:
        # Set resource limits
        try:
...
class SecureCodeExecutor:
    ...
    def execute_code(self, code: str, test_input: str = "") -> TestResult:
        ...
        # Create and start process with the worker function
